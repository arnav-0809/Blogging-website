...
app.get("/",function(req,res){
  Blog.find({},function(err,foundBlog){
    ...
    // });
    // posts=arr;
    res.render("home",{home:homeStartingContent,posts:foundBlog});
  });
});
...
app.get("/posts/:postname",function(req,res){
  ...
  Blog.findOne({link:requestedtitle},function(err,foundBlog){
    res.render("post",{storedtitle:foundBlog.title,storedcontext:foundBlog.context});
});
});
